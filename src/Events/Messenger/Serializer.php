 ...
 * Class Serializer
 *
 * Custom Serializer derived from `Symfony\Component\Messenger\Transport\Serialization\Serializer` that
 * can encode/decode the custom AbstractDomainEvent. The differences here are the use of the toArray /
 * fromArray on the AbstractDomainEvent to avoid needing to use the SF Serializer.
 *
 * @package Somnambulist\Domain\Events\Messenger
 * @subpackage Somnambulist\Domain\Events\Messenger\Serializer
 */
class Serializer implements SerializerInterface
{
     ...
     * Constructor.
     *
     * @param SymfonySerializerInterface|null $serializer
     * @param string                          $format
     * @param array                           $context
     */
    ...
    public function decode(array $encodedEnvelope): Envelope
    {
        ...
        try {
            $message = AbstractDomainEvent::fromArray(
    ...
    {
        if (!$envelope->getMessage() instanceof AbstractDomainEvent) {
            throw new InvalidArgumentException(
                sprintf('"%s" will only operate on "%s" objects', __CLASS__, AbstractDomainEvent::class)
            );
        }
