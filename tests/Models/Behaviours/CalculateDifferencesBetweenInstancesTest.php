...
class CalculateDifferencesBetweenInstancesTest extends TestCase
{
    ...
    public function testRequiresSameObjectTypeToDiff()
    {
        ...
        $this->expectExceptionMessage('Expected instance of "Somnambulist\Components\Models\Types\Identity\EmailAddress" to diff with, received "Somnambulist\Components\Models\Types\Geography\Country"');
